...
extern "C" {
     ...
     */
    typedef enum {
        DRV_ADC1_CHANNEL_VBAT_2 = 0x1F,
        DRV_ADC1_CHANNEL_AVDD = 0x1E,
        DRV_ADC1_CHANNEL_AVSS = 0x1D,
        DRV_ADC1_CHANNEL_VBG = 0x1C,
        DRV_ADC1_CHANNEL_VBG_2 = 0x1B,
        DRV_ADC1_CHANNEL_VBG_6 = 0x1A,
        DRV_ADC1_CHANNEL_CTMU = 0x19,
        DRV_ADC1_CHANNEL_CTMU_TEMPERATURE_SENSOR_INPUT = 0x18,
        DRV_ADC1_CHANNEL_AN2 = 0x02,
        DRV_ADC1_CHANNEL_AN3 = 0x03,
        DRV_ADC1_MAX_CHANNEL_COUNT = 2
    } DRV_ADC1_CHANNEL;
    /**
