...
extern "C" {
     ...
     */
    void DRV_UART1_Initialize(void) __attribute__((deprecated("\nThis will be removed in future MCC releases. \nUse UART1_Initialize instead. ")));
    ...
    /**
      ...
      @Example 
        Refer to UART1_Initializer() for an example
     */
    void UART1_TasksTransmit(void);
    /**
        void DRV_UART1_TasksTransmit ( void )
     */
    void DRV_UART1_TasksTransmit(void) __attribute__((deprecated("\nThis will be removed in future MCC releases. \nUse UART1_TasksTransmit instead. ")));
     ...
     */
    void UART1_TasksError(void);
    /**
        void DRV_UART1_TasksError ( void )
     */
    void DRV_UART1_TasksError(void) __attribute__((deprecated("\nThis will be removed in future MCC releases. \nUse UART1_TasksError instead. ")));
