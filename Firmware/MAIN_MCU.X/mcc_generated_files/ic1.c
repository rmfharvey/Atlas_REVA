...
/**
  ...
  @Summary
    This is the generated source file for the IC1 driver using MPLAB® Code Configurator
...
void IC1_Initialize(void) {
    // ICM Simple Capture mode: Rising; ICSIDL disabled; ICOV disabled; ICTSEL TMR4; ICI Every; ICBNE disabled; 
    IC1CON1 = 0x0803;
    // IC32 disabled; ICTRIG disabled; SYNCSEL None; TRIGSTAT disabled; 
    IC1CON2 = 0x0000;
    // IC1BUF disabled; 
    IC1BUF = 0x0000;
    // IC1TMR disabled; 
