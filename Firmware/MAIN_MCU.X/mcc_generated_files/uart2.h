...
extern "C" {
     ...
     */
    void DRV_UART2_Initialize(void) __attribute__((deprecated("\nThis will be removed in future MCC releases. \nUse UART2_Initialize instead. ")));
    ...
    /**
      ...
      @Example 
        Refer to UART2_Initializer() for an example
     */
    void UART2_TasksTransmit(void);
    /**
        void DRV_UART2_TasksTransmit ( void )
     */
    void DRV_UART2_TasksTransmit(void) __attribute__((deprecated("\nThis will be removed in future MCC releases. \nUse UART2_TasksTransmit instead. ")));
     ...
     */
    void DRV_UART2_TasksError(void) __attribute__((deprecated("\nThis will be removed in future MCC releases. \nUse UART2_TasksError instead. ")));
