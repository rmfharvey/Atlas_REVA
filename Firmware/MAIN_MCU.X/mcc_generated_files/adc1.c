...
void ADC1_Initialize(void) {
    // ADSIDL disabled; ASAM enabled; FORM Absolute decimal result, unsigned, right-justified; DMABM disabled; MODE12 enabled; ADON enabled; DONE disabled; SAMP disabled; SSRC Clearing sample bit ends sampling and starts conversion; DMAEN disabled; 

    AD1CON1 = 0x8404;

    // OFFCAL disabled; ALTS disabled; PVCFG AVDD; BUFM disabled; BUFREGEN disabled; NVCFG0 AVSS; SMPI 1; CSCNA enabled; 

    AD1CON2 = 0x0400;

    // ADRC FOSC/2; SAMC 12; EXTSAM disabled; ADCS 3; 
    ...
    // CSS3 enabled; CSS4 disabled; CSS5 disabled; CSS6 disabled; CSS7 disabled; CSS8 disabled; CSS9 disabled; CSS10 disabled; CSS11 disabled; CSS0 disabled; CSS12 disabled; CSS13 disabled; CSS2 enabled; CSS14 disabled; CSS1 disabled; CSS15 disabled; 

    AD1CSSL = 0x000C;

    // CSS16 disabled; CSS29 disabled; CSS17 disabled; CSS27 disabled; CSS18 disabled; CSS19 disabled; CSS28 disabled; CSS30 disabled; CSS21 disabled; CSS22 disabled; CSS20 disabled; CSS25 disabled; CSS26 disabled; CSS23 disabled; CSS24 disabled; 

    AD1CSSH = 0x0000;

    // VBGEN disabled; VBG2EN disabled; VBG6EN disabled; 
