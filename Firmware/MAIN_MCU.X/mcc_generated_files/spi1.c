...
void SPI1_Initialize(void) {
    // SPI Frequency = 2,000,000 Hz; SSEN disabled; PPRE 1:1; SMP Sample at Middle; MSTEN enabled; MODE16 disabled; DISSCK disabled; SPRE 4:1; CKE Idle to Active; DISSDO disabled; CKP Idle:Low, Active:High; 
    SPI1CON1 = 0x0033;
